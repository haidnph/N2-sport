...
<?php foreach($sizes as $s): ?>
    <button 
        class="size-btn px-4 py-2 border rounded-xl transition"
            ...
            <form action="index.php?url=add-to-cart" method="POST">
              ...
              <div class="flex items-center gap-10 mt-5">
                ...
                <div class="bg-gray-200 w-[150px] rounded-3xl flex items-center justify-between p-1">
                  <button type="button" id="increase" class="text-2xl ml-3">+</button>
                  ...
                  <button type="button" id="decrease" class="text-2xl mr-3">-</button>
                </div>

                <!-- ID sản phẩm -->
                <input type="hidden" name="id" value="<?= $product['product_id'] ?>">

                <button class="bg-black text-white px-6 py-2 rounded-3xl">
                  Add To Cart
                </button>
